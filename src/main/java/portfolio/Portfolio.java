...
public class Portfolio implements SummarizingAccount{
	...
	public void visitTransactionsWith(AccountTransactionVisitor aVisitor) {
		for(SummarizingAccount summarizingAccount : summarizingAccounts )
			summarizingAccount.visitTransactionsWith(aVisitor);
	}
	...
	public void visitAccountsWith(SummurizingAccountVisitor aVisitor) {
		for (SummarizingAccount summarizinAccount : summarizingAccounts) {
